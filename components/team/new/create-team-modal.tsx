...
} from "@/lib/handlers/handle-client-side-api-response"
    ...
    <>
      <Dialog>
        <DialogTrigger className="h-full w-full" asChild>
          <Button variant="ghost" className="h-full w-full justify-start">
        ...
        <DialogContent className="max-w-md rounded-lg p-6">
          <DialogHeader className="space-y-4">
            ...
            <DialogDescription>
              Continue to start collaborating with increased usage, additional
