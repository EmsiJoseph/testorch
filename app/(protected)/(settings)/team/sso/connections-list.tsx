                      ...
                      <DropdownMenuContent align="end" className="w-[160px]">
                        {c.strategy === "oidc" && (
                          <>
                            <DropdownMenuItem asChild>
                              <Link
                                href={`/team/sso/oidc/edit/${c.id}/settings`}
                              >
                            ...
                            <DropdownMenuItem asChild>
                              <Link
                                href={`/team/sso/oidc/edit/${c.id}/provisioning`}
                              >
                        ...
                        {c.strategy === "samlp" && (
                          <>
                            <DropdownMenuItem asChild>
                              <Link
                                href={`/team/sso/saml/edit/${c.id}/settings`}
                              >
                                <GearIcon className="mr-1 size-4" />
                                Settings
                              </Link>
                            ...
                            <DropdownMenuItem asChild>
                              <Link
                                href={`/team/sso/saml/edit/${c.id}/provisioning`}
                              >
                                <PersonIcon className="mr-1 size-4" />
                                Provisioning
                              </Link>
      ...
      <CardFooter className="flex justify-end">
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-[160px]">
            <DropdownMenuItem asChild>
              <Link href="/team/sso/oidc/new">OIDC</Link>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
              <Link href="/team/sso/saml/new">SAML</Link>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </CardFooter>
